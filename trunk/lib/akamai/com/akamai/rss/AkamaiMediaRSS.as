package com.akamai.rss{
	...
	public class AkamaiMediaRSS extends EventDispatcher {
		...
		private function buildMediaObject(node:XML):Media {
				...
				thumbnail.url = node.mediaNs::thumbnail.@url;
				thumbnail.height = Number(node.mediaNs::thumbnail.@height);
				thumbnail.width = Number(node.mediaNs::thumbnail.@width);
				thumbnail.time = node.mediaNs::thumbnail.@width;
